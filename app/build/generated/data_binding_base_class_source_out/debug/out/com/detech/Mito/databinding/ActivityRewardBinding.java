...
public final class ActivityRewardBinding implements ViewBinding {
  ...
  @NonNull
  public final ImageView video2Icon;

  @NonNull
  public final LinearLayout video3;

  @NonNull
  public final ImageView video3Icon;

  @NonNull
  public final LinearLayout video4;

  @NonNull
  public final ImageView video4Icon;

  @NonNull
  public final LinearLayout video5;

  @NonNull
  public final ImageView video5Icon;
  ...
  private ActivityRewardBinding(@NonNull ConstraintLayout rootView, @NonNull TextView coins,
      ...
      @NonNull ImageView video1Icon, @NonNull LinearLayout video2, @NonNull ImageView video2Icon,
      @NonNull LinearLayout video3, @NonNull ImageView video3Icon, @NonNull LinearLayout video4,
      @NonNull ImageView video4Icon, @NonNull LinearLayout video5, @NonNull ImageView video5Icon) {
    ...
    this.video2 = video2;
    this.video2Icon = video2Icon;
    this.video3 = video3;
    this.video3Icon = video3Icon;
    this.video4 = video4;
    this.video4Icon = video4Icon;
    this.video5 = video5;
    this.video5Icon = video5Icon;
  }
  ...
  public static ActivityRewardBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.video2Icon;
      ImageView video2Icon = rootView.findViewById(id);
      if (video2Icon == null) {
        break missingId;
      }
      ...
      id = R.id.video3Icon;
      ImageView video3Icon = rootView.findViewById(id);
      if (video3Icon == null) {
        break missingId;
      }
      ...
      id = R.id.video4Icon;
      ImageView video4Icon = rootView.findViewById(id);
      if (video4Icon == null) {
        break missingId;
      }
      ...
      id = R.id.video5Icon;
      ImageView video5Icon = rootView.findViewById(id);
      if (video5Icon == null) {
        break missingId;
      }
      ...
      return new ActivityRewardBinding((ConstraintLayout) rootView, coins, imageView3, imageView7,
          ...
          video2Icon, video3, video3Icon, video4, video4Icon, video5, video5Icon);
    }
