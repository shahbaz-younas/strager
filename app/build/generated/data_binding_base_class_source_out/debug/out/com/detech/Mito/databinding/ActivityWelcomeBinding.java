...
public final class ActivityWelcomeBinding implements ViewBinding {
  ...
  private ActivityWelcomeBinding(@NonNull ConstraintLayout rootView, @NonNull Button getStarted,
      @NonNull ImageView imageView, @NonNull ImageView imageView3, @NonNull TextView textView,
  ...
  public static ActivityWelcomeBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      id = R.id.getStarted;
      Button getStarted = rootView.findViewById(id);
      if (getStarted == null) {
        break missingId;
      }
      ...
      return new ActivityWelcomeBinding((ConstraintLayout) rootView, getStarted, imageView,
