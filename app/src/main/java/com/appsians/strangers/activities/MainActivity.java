            ...
            public void onClick(View view) {
                if(isPermissionsGranted()) {
                    if (coins > 5) {
                        ...
                        new AlertDialog.Builder(MainActivity.this).setTitle("Warning").setMessage("Insufficient Coins").setPositiveButton("Get Coins", new DialogInterface.OnClickListener() {
                            @Override
